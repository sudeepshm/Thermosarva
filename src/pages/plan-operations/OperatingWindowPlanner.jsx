...
import { operatingWindowData } from '../../data/mockData';
import {
      ...
      <div className="three-col mb-20">
        <div style={{
          ...
          <div style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: '1.1rem', color: 'var(--status-ok)' }}>
            {operatingWindowData.recommended.label}
          </div>
          <div style={{ fontFamily: 'Outfit', fontWeight: 700, fontSize: '1.5rem', color: 'var(--text-primary)', marginTop: 4 }}>
            {operatingWindowData.recommended.start} – {operatingWindowData.recommended.end}
          </div>
        ...
        <div style={{
          ...
          <div style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: '1.1rem', color: 'var(--status-critical)' }}>
            {operatingWindowData.avoidLabel}
          </div>
          <div style={{ fontFamily: 'Outfit', fontWeight: 700, fontSize: '1.5rem', color: 'var(--text-primary)', marginTop: 4 }}>
            {operatingWindowData.avoidStart} – {operatingWindowData.avoidEnd}
          </div>
          <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginTop: 6 }}>
        ...
        <div style={{
          ...
          <div style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: '1.1rem', color: 'var(--status-info)' }}>
            {operatingWindowData.secondary.label}
          </div>
          <div style={{ fontFamily: 'Outfit', fontWeight: 700, fontSize: '1.5rem', color: 'var(--text-primary)', marginTop: 4 }}>
            {operatingWindowData.secondary.start} – {operatingWindowData.secondary.end}
          </div>
          <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginTop: 6 }}>
        ...
        <div className="panel-body">
          <div className="chart-container-tall">
            <ResponsiveContainer width="100%" height="100%">
              <ComposedChart data={operatingWindowData.timeline} margin={{ top: 8, right: 8, left: -8, bottom: 0 }}>
                <defs>
      ...
      <div className="panel">
        ...
        <div className="panel-body">
          ...
          <div style={{ marginTop: 14, display: 'flex', gap: 16, fontSize: '0.8rem', color: 'var(--text-muted)' }}>
            <div><strong style={{ color: 'var(--text-primary)' }}>Peak Business:</strong> {operatingWindowData.peakBusiness}</div>
          </div>
        </div>
      </div>
    </div>
